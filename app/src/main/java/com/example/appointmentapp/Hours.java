            ...
            public void onClick(View v) {
                ...
                for(int i = 0; i < closeField.size(); i++){
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                        openTimes = String.valueOf(openField.get(i).getHour() + ":" + (String.valueOf(openField.get(i).getMinute()).length()==1 ? "0" : "") +String.valueOf(openField.get(i).getMinute()));
                    }
                    String closeTimes = null;
                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                        closeTimes = String.valueOf(closeField.get(i).getHour() + ":" + (String.valueOf(closeField.get(i).getMinute()).length()==1 ? "0" : "" )+ String.valueOf(closeField.get(i).getMinute()));
                    }
